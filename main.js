...
// block = new Block(0, 'ejemplo');
// console.log(JSON.stringify(block, null, 2));

let naniCoin = new BlockChain('informacion de genesis', '00');

naniCoin.addBlock('informacion del bloque');
naniCoin.addBlock('Mas datos del bloque');
